...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "preview.no_summary_hint":  "The transcript is saved locally. The LLM may be unreachable, rate-limited, or out of quota — click 'View log' for the exact reason, or switch provider in Settings → AI Model (remember to Save), then try again.",
        "preview.no_speech":        "No speech detected in the audio.",
        "preview.no_speech_hint":   "The recording may have no audio track, be silent, or contain only music / noise. Check that someone is actually speaking in the file, then try a different recording.",
        ...
        "settings.ai.test_ok":          "✓ Connected · {n} model(s) — click Save to apply",
    ...
    "id": {
        ...
        "preview.no_summary_hint":  "Transkrip tersimpan lokal. LLM mungkin tidak terjangkau, kena rate-limit, atau kuota habis — klik 'View log' untuk lihat alasannya, atau ganti provider di Settings → AI Model (jangan lupa Save), lalu coba lagi.",
        "preview.no_speech":        "Tidak ada suara terdeteksi di audio.",
        "preview.no_speech_hint":   "Recording mungkin gak ada audio track, silent, atau cuma musik / noise. Pastikan ada orang yang ngomong di file-nya, lalu coba recording lain.",
        ...
        "settings.ai.test_ok":          "✓ Terkoneksi · {n} model — klik Simpan untuk menerapkan",
        "settings.ai.test_err":         "✗ {err}",
